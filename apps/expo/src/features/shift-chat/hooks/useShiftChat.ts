...
/**
 * Shift-chat polling + mutations. Ported from web `useShiftChat`; the only
 * change is `sonner` → the `@/lib/toast` seam. Realtime is intentionally
 * poll-based here (no SSE in Expo until Phase 6).
 */
