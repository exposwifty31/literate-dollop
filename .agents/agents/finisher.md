...
*Canonical, version-controlled copy of the finisher persona. To spawn this as a Claude
Code subagent locally, copy it to the gitignored `.claude/agents/finisher.md` (Claude
Code discovers subagents there).*
