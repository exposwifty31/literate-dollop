...
**Prerequisites:** `LITERATE_DOLLOP_PARITY_REPORT.md` (in vettrack), `PRODUCT_MODEL.md` §Mobile dual-track, literate-dollop [`docs/plans/mobile-strategy-master.md`](../plans/mobile-strategy-master.md)
...
| Artifact | Purpose |
|----------|---------|
| `PRODUCT_MODEL.md` | Product vision, personas, critical paths, mobile dual-track |
| `PRODUCT_ALIGNMENT_REPORT.md` | Live product vs stated scope |
| `ARCHITECTURE_MAP.md` | Module/route/worker inventory |
| `GITHUB_GOVERNANCE.md` | Branch/MR/remote drift audit |
| `CI_CD_GOVERNANCE.md` | Pipeline maturity, gate gaps |
| `ENGINEERING_FRICTION_REPORT.md` | Delivery friction ranked by product impact |
| `PRODUCT_DRIVEN_IMPROVEMENT_PLAN.md` | P0–P3 prioritized execution plan |
| `FROZEN_SURFACE_CHANGE_PROTOCOL.md` | Checklist for SSE/PWA/Code Blue/authority changes |
| `LITERATE_DOLLOP_PARITY_REPORT.md` | Cross-repo lite governor pass on Expo repo |
...
**Sequencing rule:** H0 (Capacitor) is complete enough that H1 scaffold is unblocked. Scale H3+ bedside work; do not wait for GitLab remote reconciliation — but **do** fix cross-repo doc lies.
...
| **E-P0-3** | On every PR touching `packages/contracts`, run `pnpm contracts:gate` **and** note that vettrack must bump dep | Prevents contracts drift |
...
| Topic | Location |
|-------|----------|
| Parity audit (detailed) | `LITERATE_DOLLOP_PARITY_REPORT.md` in vettrack repo |
| Monolith improvement backlog | `PRODUCT_DRIVEN_IMPROVEMENT_PLAN.md` in vettrack repo |
| Product + mobile horizons | `PRODUCT_MODEL.md` §Mobile dual-track in vettrack repo |
| Expo master plan | [docs/plans/mobile-strategy-master.md](../plans/mobile-strategy-master.md) |
| Porting status | [docs/porting-status.md](../porting-status.md) |
| Contracts bump runbook | [docs/contracts-bump-runbook.md](../contracts-bump-runbook.md) |

---

## 8. Next actions (suggested order)

1. **E-P0-1** — Sync literate-dollop docs with GitHub reality (pair with vettrack P0-1 when decided). ✅ Done 2026-06-19
